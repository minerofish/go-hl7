...
type PV1 struct {
	...
	DeleteAccountDate       time.Time   `hl7:"35,shortdate"`
	DischargeDisposition    string      `hl7:"36"`
	DischardedToLocation    DLD         `hl7:"37"`
	...
	AdmitDateTime           time.Time   `hl7:"44,longdate"`
	DischargeDateTime       []time.Time `hl7:"45,longdate"`
